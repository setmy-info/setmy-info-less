...
// LESS -> CSS. Two outputs per entry point, the same two-artifact convention
// the JS sibling has for index.js / index.min.css:
...
if (fs.existsSync(pugDir)) {
    execFileSync(
        process.execPath,
        [path.join(rootDir, "scripts", "pugBuild.cjs")],
        {
