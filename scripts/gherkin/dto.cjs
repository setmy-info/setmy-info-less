...
const then = {
    ...
    pageElementMarginShouldBe: (margin) =>
        step("Then", "pageElementMarginShouldBe", margin),
    pageElementPaddingShouldBe: (padding) =>
        step("Then", "pageElementPaddingShouldBe", padding),
    pageElementFontFamilyShouldBe: (fontFamily) =>
        step("Then", "pageElementFontFamilyShouldBe", fontFamily),
    pageElementFontSizeShouldBe: (fontSize) =>
        step("Then", "pageElementFontSizeShouldBe", fontSize),
    pageElementXShouldBe: (x) => step("Then", "pageElementXShouldBe", x),
    pageElementYShouldBe: (y) => step("Then", "pageElementYShouldBe", y),
    pageElementWidthShouldBe: (width) =>
        step("Then", "pageElementWidthShouldBe", width),
    pageElementHeightShouldBe: (height) =>
        step("Then", "pageElementHeightShouldBe", height),
    pageElementTopShouldBe: (top) =>
        step("Then", "pageElementTopShouldBe", top),
    pageElementLeftShouldBe: (left) =>
        step("Then", "pageElementLeftShouldBe", left),
    pageElementBackgroundColorShouldBe: (color) =>
        step("Then", "pageElementBackgroundColorShouldBe", color),
    pageElementColorShouldBe: (color) =>
        step("Then", "pageElementColorShouldBe", color),
    pageElementStyleShouldBe: (propertyName, value) =>
        step("Then", "pageElementStyleShouldBe", propertyName, value),
