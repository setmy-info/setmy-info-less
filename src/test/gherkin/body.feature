Feature: Body page
    ...
    Scenario: Main html parts
        ...
        Then element with id "application" should have margin "0px 0px 0px 0px", padding "0px 0px 0px 0px", font "Arial", font size "16px", width 2000px, height 1200px, background color "rgba(0, 0, 0, 0)", text color "rgb(0, 0, 0)"
        Then page is closed
