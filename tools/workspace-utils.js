...
// Maven-style source layout, kept from this repo's own convention:
// src/main/less/main.less is every package's single LESS entry point
// (src/test/pug and src/test/js hold the test-side sources).
